...
const Upload = () => {
  ...
  return (
    <div className='flex w-full h-full absolute left-0 top-[60px] 
                    mb-10 pt-10 lg:pt-20 bg-[#F8F8F8] justify-center'>
        <div className='bg-white rounded-xl xl:h-[90vh] flex gap-6 flex-wrap 
        justify-between items-center p-14 pt-6w w-[60%]'>
            <div>
                <div>
                ...
                <div className='border-dashed rounded-xl border-4 border-gray-200
                                ...
                                outline-none mt-10 w-[260px] h-[460px] p-10 
                                cursor-pointer hover:border-black hover:bg-gray-100'>
                    {isLoading ?(
                        <p>Loading...</p>
                    ): (
                        <div>
            ...
            <div>
                    <div className='flex flex-col gap-3 pb-10'>
                        ...
                        <select className='outline-none border-2 border-gray-200 text-md
                        ...
                        <div className='flex gap-6 mt-10'>
                            ...
                            onClick={handlePost}
                            type="button"
                            className='bg-[#F51997] text-white border-gray-300 text-md font-medium p-2 rounded 
                            w-28 lg:w-44 outline-none'
                            >Post</button>
                        </div>
                    </div>
